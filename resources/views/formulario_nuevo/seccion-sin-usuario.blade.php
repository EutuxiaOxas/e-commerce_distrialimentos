    ...
    <section id=form_new_user class="pb-1 formularios__sections container-width2 m-0">
                ...
                <div class="col-9 d-flex align-items-center col-md-10">
                    <div class="user-info">
                        <div class="wrapper-info">
                            ...
                            <p class="texto-small text-muted">Al parecer aún no tienes una cuenta en Distrialimentos del centro.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="">
            ...
            <div class="wrapper boxed border shadow p-4 bg-white info-container">
                ...
                <div class="col text-center">
                    <p class="text-muted">Para continuar debes tener una cuenta...</p>            
                </div>
                </div>
                <div class="row pt-3">
                <div class="col text-center">

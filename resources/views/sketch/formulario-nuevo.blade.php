...
<section id=form_new_user>
    <!-- User-header -->
    <section class="user-header mt-3 py-2">
    ...
    <!-- Carrito formulario-->
    <section class="form-shoppingCar">
    ...
    <section class="user-info">
      <div class="user-info container p-4">
        <div class="wrapper boxed border shadow p-4">
          <div class="user_info-img row"> 
            <div class="col text-center">
              <img src="{{asset('images/imgs/new-user.svg')}}" alt="">
            </div>
          </div>
...
<section id=form_datos>
    ...
    <section class="datos-info">
      <div class="datos-info-circle container">
        <div class="circle row p-2">
          <div class="circle-number col-1 pl-1">
            <button class="rounded-circle circle_number bg-primary border-0">
              <p class="text-white small">1</p>
            </button>
          </div>
          <div class="circle-text col-11 d-flex align-items-center">
            <p class="font-weight-bold small text-black">Datos del comprador</p>
          </div>
        </div>   
      </div>
      <div class="datos-info container px-4 pb-4">
        <div class="wrapper boxed border shadow p-4">
...
<section id=form_bussines>
    ...
    <section class="datos-info">
      <div class="datos-info-circle container">
        <div class="circle row p-2">
          <div class="circle-number col-1 px-1">
            <button class="rounded-circle circle_number bg-dark border-0">
              <p class="text-white small">1</p>
            </button>
          </div>
          <div class="circle-number col-2 pl-4">
            <button class="rounded-circle circle_number bg-primary border-0">
              <p class="text-white small">2</p>
            </button>
          </div>
          <div class="circle-text col-9 d-flex align-items-center">
      ...
      <div class="datos-info container px-4 pb-4">
        <div class="wrapper boxed border shadow p-4">
          <div class="datos_info-img row"> 
            <div class="col text-center">
              <img src="{{asset('images/imgs/new-bussines.svg')}}" alt="">
            </div>
          </div>
          <div class="datos-info-text row py-2">
            <div class="col text-center">
...
<section id=form_envio>
    ...
    <section class="envio-info">
      <div class="envio-info-circle container">
        <div class="circle row p-2">
          <div class="circle-number col-2 pl-1">
            <button class="rounded-circle circle_number bg-dark border-0">
              <p class="text-white small">1</p>
            </button>
          </div>
          <div class="circle-number col-2 p-0">
            <button class="rounded-circle circle_number bg-dark border-0">
              <p class="text-white small">2</p>
            </button>
          </div>
          ...
          <div class="circle-text col-6 d-flex align-items-center pl-0">
      ...
      <div class="datos-info container px-4 pb-4">
        <div class="wrapper boxed border shadow p-4">
          <div class="datos_info-img row"> 
            <div class="col text-center">
              <img src="{{asset('images/imgs/new-delivery.svg')}}" alt="">
            </div>
          </div>
          <div class="datos-info-text row py-2">
            <div class="col text-center">

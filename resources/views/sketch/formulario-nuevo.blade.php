      ...
      <div class="container container-width-md">
        <div class="row">
          ...
          <div class="col-7 pl-0">
            <button id=btn_next1 class="btn btn-primary btn-sm btn-block formularios__btn-right">Iniciar seccion</button>
          </div>
        </div>
      </div>
    </section>
       ...
       <!-- Numbers-->
        ...
        <div class="container container-width-md p-4">
          ...
          <div class="datos-info-link row pt-3">
            <div class="col  text-center">
              <a href="#" data-toggle="modal" data-target="#modal-user_data"> <p class="font-weight-bold text center text-secondary">Agregar datos del comprador</p></a>          
            </div>
      ...
      <div class="datos-info container container-width-md px-4 pb-4">
        ...
        <div class="wrapper boxed border shadow p-4">
          <div class="datos_info-img row"> 
            <div class="col text-center">
              <img class="formularios__imgWidth" src="{{asset('images/imgs/new-bussines.svg')}}" alt="">
            </div>
          </div>
    ...
    <section class="venta-info pt-4">
      ...
      <div class="datos-info container container-width-md px-4 pb-4">
        <div class="wrapper boxed border shadow p-4">
          <div class="datos_info-img row"> 
            <div class="col text-center">
              <img class="formularios__imgWidth" src="{{asset('images/imgs/logistic.svg')}}" alt="">
            </div>
          </div>
          <div class="datos-info-text row py-2">
            <div class="col text-center">

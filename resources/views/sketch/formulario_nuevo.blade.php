...
<section class="formularios__sectionColor formularios__containerMain">
    ...
    <section id=form_new_user class="pb-1 formularios__sections container-width2 m-0">
                                    ...
                                    <div class="Modal-body-card row boxed border shadow radeus">
                                        ...
                                        <div class="Modal-body_info col-8 col-md-8 px-0">
                                            <div class="prod-details p-1">
                                                <div class="row mb-0">
                                                    <div class="col-10 prod-details_title my-0 py-0">
                                                        <h5 class="text-blue font-weight-bold my-0 pb-0 text-left">Titulo del producto</h5>
                                                    </div>
                                                    <div class="col-2 prod-details_delete">
        ...
        <section class="">
            ...
            <div class="wrapper boxed border shadow p-4 info-container">
                ...
                <div class="col text-center">
                    <p class="text-muted">Aun no te has registrado... <br> Para continuar debes tener una cuenta</p>            
                </div>
                </div>
                <div class="row pt-3">
                <div class="col text-center">
    ...
    <section class="pt-5 mt-5 d-none d-md-block">
      <div class="container">
        <div class="row container">
          <div class="col p-4 formularios__TotalCompra">
            ...
            <div class="container">
              ...
              <div class="row mb-0 pb">
                ...
                <div class="col-6 mb-1">
                  <p class="text-right text-muted">53,76 $</p>
                </div>
              </div>    
              ...
              <div class="row mb-0 pb-1">
                ...
                <div class="col-6 mb-1">
                  <p class="text-right text-muted">8,00 $</p>
                </div>  
              </div>

              <div class="row mb-0">
                <div class="col-6 mb-1">
                  <p class="lead text-secondary font-weight-bold">TOTAL</p>
                </div>
                <div class="col-6 mb-1">
                  <p class="lead font-weight-bold text-black text-right">65,00 $</p>
                </div>
              </div> 

              <div class="row mb-0 pb-2">
                <div class="col-6 mb-1">
                  <p class=" font-weight-bold text-secondary">TOTAL(Bs)</p>
                </div>
                <div class="col-6 mb-1">
                  <p class=" font-weight-bold text-right">90.000.000,00 Bs</p>
                </div> 
              </div>
            </div>

  ...
  <section id=formulario1 class="p-0 m-0 show">
    <!-- usuario -->
      <section class="py-0">
        <div class="container">
          <div class="row py-1">
            <div class="col-3 mb-0 d-flex justify-content-center pr-0">
        ...
        <div class="boxed border shadow">
          <div class="info-container p-2">
            ...
            <div class="row mb-3">
              ...
              <div class="col-6">
                <p class="small">C.I. 20.409.372</p>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-6">
              ...
              <div class="col-6">
                <p class="small">+58 412 786 9664</p>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-5 pr-0">
            <button class="btn btn-secondary btn-sm btn-block disabled radius-right text-secondary">x</button>
          </div>
  ...
  <!-- /datos de empresa-->
          ...
          <div class="boxed border shadow">
            <div class="info-container p-2">
              <div class="row mb-3">
                ...
                <div class="col-6">
                  <p class="small">Eutuxia Group C.A</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-6">
                ...
                <div class="col-6">
                  <p class="small">R.I.F J- 239872321 - 2</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-6">
              ...
              <div class="row mb-3">
                ...
                <div class="col-6">
                  <p class="small">8:00 AM - 11:00 AM</p>
                </div>
              </div>
              <div class="row">
                <div class="col-12 text-center">
        ...
        <div class="container mt-1 pt-0">
          <div class="row">
            <div class="col">
              <div class="boxed border shadow">
                <div class="info p-1 mb-1">
                  <p class="font-weight-bold text-black small">Direccion Juridica</p>
      ...
      <section class="my-0 py-1">
        <div class="container">
          <div class="row">
            ...
            <div class="col-7 pl-0">
              <button id=btn_next3 class="btn btn-primary btn-sm btn-block radius-left font-weight-bold">Siguiente</button>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="boxed border shadow">
              <div class="box-body p-2">
                <figure class="text-center">
                  <img src="{{asset('images/imgs/img.png')}}" alt="imag">  
                </figure>
                <h4 class="font-weight-bold text-center text-primary">Gracias por su compra</h4>

    ...
    <div class="container">
      <div class="row py-1">
        ...
        <div class="col-9 pl-0">
          <div class="user-info p-1 d-flex align-items-center pl-0">
        ...
        <div class="info-container p-2">
          ...
          <div class="row">
            <div class="col-12 text-center">
              <a href="#" class="small">Editar datos de comprador</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-7 pl-0">
        <button class="btn btn-primary btn-sm btn-block radius-left font-weight-bold">Siguiente</button>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
  <div class="row p-1">
    <div class="col-2 my-0 pr-0">
      <button class="rounded-circle btn-steps bg-blue border-0">
        <p class="text-white small">1</p>
      </button>
    </div>
    <div class="col-2 my-0 pr-0">
...
<div class="container mt-1">
  <div class="boxed border shadow">
    <div class="info-container p-2">
      ...
      <div class="row">
        <div class="col-12 text-center">
          <a href="#" class="small">Editar datos de empresa</a>
        </div>
      </div>
    </div>
  </div>

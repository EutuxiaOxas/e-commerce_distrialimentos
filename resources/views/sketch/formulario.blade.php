...
<section id=formulario1 class="p-0 m-0 show">
  ...
  <section class="pb-0 pt-2">
    <div class="container">
      <div class="row py-1">
        <div class="col-3 formularios__containerBtn-Precio col-md-2 col-lg-1">
        ...
        <div class="col-9 d-flex align-items-center col-md-10 col-lg-11">
          <div class="user-info">

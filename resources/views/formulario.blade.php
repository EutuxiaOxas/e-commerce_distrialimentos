...
<!-------------------------- Formulario I ----------------------------->
          ...
          <div class="border shadow">
            <div class="info-container p-3">
              <div class="row mb-3">
                ...
                <div class="col-6">
                  <p class="texto-small text-muted text-md-right">Juan Perez</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-6">
  ...
  <!-------------------------- Formulario V ----------------------------->
  <section id="formulario5" class="formularios__Finalizarcompra mostrar noMostrar formularios__Height">
    <div class="container">
...
<!-------------------------- Javascript ----------------------------->
    ...
    $btn_next3.addEventListener('click', () => { 
      if ($mq.matches){
        $form3.classList.toggle('hide')&$form5.classList.toggle('mostrar')&$saludo.classList.toggle('hide');
      }
      else {
        $form3.classList.toggle('hide')&$form4.classList.toggle('hide')&$saludo.classList.toggle('hide');
      }
    });

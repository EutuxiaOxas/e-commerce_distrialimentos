...
@section('title')
   Admin - Crear Banner promocional
@endsection
...
@section('content')
    ...
    <div class="row p-2">
        <h3 class="col-auto">Crear Nuevo Banner Promocional</h3>
        <div class="col-auto ml-auto"><a class="btn btn-outline-info btn-sm px-5" href="{{ route('promociones.home') }}">Volver</a></div>
    </div>

    <section class="my-3" id="container">        
        <form action="{{ route('promociones.store') }}" id="form" method="POST"
        enctype="multipart/form-data">
        @csrf
            <p class="pt-2"><b>Seleccione</b> El tipo de Banner</p>
            <select class="form-control" name="tipo" id="" >
                {{-- <option value="principal" selected >Banner Principal</option> --}}
                <option value="promocional" selected>Banner Promocional</option>
            </select>
            <p class="pt-2"><b>Ingrese</b> la URL del Banner <span class="text-muted">(Opcional)</span></p>
        ...
        <div class="d-flex justify-content-center my-3 ">
            ...
            <a href="{{ route('promociones.home') }}" class="btn btn-outline-danger">Cancelar</a>
        </div>
    </section>
